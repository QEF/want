!
! Input/Output Tool Kit (IOTK) 0.3.2
...
! WITH SPREP 0.3.0 ON mer nov 24 15:59:50 CET 2004
!
...
character(100), parameter :: iotk_version = "0.3.2"
...
interface
subroutine iotk_copyfile(source,dest,source_unit,dest_unit,ierr)
...
subroutine iotk_error(unit,ierr)
  ...
  write(0,*) "#################################"
  write(0,*) "Error in Input/Output Tool Kit, version " // "0.3.2"
  write(0,*) "Code        : ",ierr
  write(0,*) "Unit        : ",unit
