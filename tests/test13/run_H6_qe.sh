#! /bin/bash
#
# Hydrogen Chain, using Quantum-ESPRESSO data
# 
#================================================================
#
...
MANUAL=" Usage
 ...
 dft             perform all the DFT calculations together
 ...
 dos             interpolate DOS using WFs
 conductor       evaluate the transmittance, for the bulk case
 want            perform DISENTANGLE, WANNIER, BANDS, DOS, CONDUCTOR all together 
