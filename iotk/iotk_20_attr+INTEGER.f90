...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER1_0(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER1_1(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER1_2(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER1_3(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER1_4(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER1_5(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER1_6(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER1_7(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
subroutine iotk_private_pack_INTEGER2(out,in,n,l)
    ...
    integer,                                    intent(in)  :: n,l
# 92 "iotk_attr.spp"
    INTEGER (kind=iotk_INTEGER2), intent(out) :: out(n)
    INTEGER (kind=iotk_INTEGER2), intent(in)  :: in(n)
# 95 "iotk_attr.spp"
    out = in
...
subroutine iotk_write_INTEGER2(val,string,ierr)
  ...
  use iotk_misc_interf
  implicit none
  INTEGER(kind=iotk_INTEGER2), intent(in) :: val(:)
#ifdef __IOTK_WORKAROUND6
  character(len=*)              :: string
#else
  character(len=*), intent(out) :: string
...
subroutine iotk_read_INTEGER2(val,string,index,ierr)
  ...
  use iotk_misc_interf
  implicit none
  INTEGER(kind=iotk_INTEGER2), intent(inout) :: val(:)
  character(len=*), intent(in) :: string
  integer, intent(inout) :: index
  integer, intent(out) :: ierr
# 173 "iotk_attr.spp"
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER2_0(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
subroutine iotk_scan_attr_INTEGER2_0(attr,name,val,dummy,found,default,eos,ierr)
  ...
  character(*),             intent(in)  :: name
#ifdef __IOTK_WORKAROUND6
  INTEGER(kind=iotk_INTEGER2)                        :: val 
#else
  INTEGER(kind=iotk_INTEGER2), intent(out)           :: val 
#endif
  type(iotk_dummytype), optional :: dummy
  logical,        optional, intent(out) :: found
  INTEGER(kind=iotk_INTEGER2), optional, intent(in)  :: default 
  logical,        optional, intent(in)  :: eos
  integer,        optional, intent(out) :: ierr
  integer :: ierrl
  integer :: attlen,pos,equal,namlen
...
# 364 "iotk_attr.spp"
  integer :: index
  INTEGER(kind=iotk_INTEGER2), allocatable :: tmpval (:)
# 367 "iotk_attr.spp"
  ierrl = 0
  attlen=iotk_strlen(attr)
  namlen=iotk_strlen_trim(name)
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER2_1(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER2_2(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER2_3(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER2_4(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER2_5(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER2_6(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER2_7(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
subroutine iotk_private_pack_INTEGER3(out,in,n,l)
    ...
    integer,                                    intent(in)  :: n,l
# 92 "iotk_attr.spp"
    INTEGER (kind=iotk_INTEGER3), intent(out) :: out(n)
    INTEGER (kind=iotk_INTEGER3), intent(in)  :: in(n)
# 95 "iotk_attr.spp"
    out = in
...
subroutine iotk_write_INTEGER3(val,string,ierr)
  ...
  use iotk_misc_interf
  implicit none
  INTEGER(kind=iotk_INTEGER3), intent(in) :: val(:)
#ifdef __IOTK_WORKAROUND6
  character(len=*)              :: string
#else
  character(len=*), intent(out) :: string
...
subroutine iotk_read_INTEGER3(val,string,index,ierr)
  ...
  use iotk_misc_interf
  implicit none
  INTEGER(kind=iotk_INTEGER3), intent(inout) :: val(:)
  character(len=*), intent(in) :: string
  integer, intent(inout) :: index
  integer, intent(out) :: ierr
# 173 "iotk_attr.spp"
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER3_0(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
subroutine iotk_scan_attr_INTEGER3_0(attr,name,val,dummy,found,default,eos,ierr)
  ...
  character(*),             intent(in)  :: name
#ifdef __IOTK_WORKAROUND6
  INTEGER(kind=iotk_INTEGER3)                        :: val 
#else
  INTEGER(kind=iotk_INTEGER3), intent(out)           :: val 
#endif
  type(iotk_dummytype), optional :: dummy
  logical,        optional, intent(out) :: found
  INTEGER(kind=iotk_INTEGER3), optional, intent(in)  :: default 
  logical,        optional, intent(in)  :: eos
  integer,        optional, intent(out) :: ierr
  integer :: ierrl
  integer :: attlen,pos,equal,namlen
...
# 364 "iotk_attr.spp"
  integer :: index
  INTEGER(kind=iotk_INTEGER3), allocatable :: tmpval (:)
# 367 "iotk_attr.spp"
  ierrl = 0
  attlen=iotk_strlen(attr)
  namlen=iotk_strlen_trim(name)
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER3_1(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER3_2(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER3_3(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER3_4(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER3_5(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER3_6(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER3_7(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER4_3(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER4_4(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER4_5(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER4_6(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 249 "iotk_attr.spp"
subroutine iotk_write_attr_INTEGER4_7(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
