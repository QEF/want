...
\noindent\llap{\hbox to \descindent{\tt dftdata\_fmt\hfil}}%
...
\noindent\llap{\hbox to \descindent{\tt wantdata\_fmt\hfil}}%
...
\noindent\llap{\hbox to \descindent{\tt delta\_ratio\hfil}}%
...
\noindent\llap{\hbox to \descindent{\tt smearing\_type\hfil}}%
...
\noindent\llap{\hbox to \descindent{\tt nk(2)\hfil}}%
...
\noindent\llap{\hbox to \descindent{\tt nk(3)\hfil}}%
{\sc integer} \\ The 3D \textbf{k}-point mesh used to compute the DOS. \\
{\sc default} = {\tt mandatory} \par

\noindent\llap{\hbox to \descindent{\tt s(3)\hfil}}%
...
\noindent\llap{\hbox to \descindent{\tt use\_nn(3)\hfil}}%
...
\noindent\llap{\hbox to \descindent{\tt projdos\hfil}}%
{\sc logical} \\ if {\tt .TRUE.} computes and writes WFs projected-DOS. \\
{\sc default} = {\tt .FALSE.} \par
}\bigskip
