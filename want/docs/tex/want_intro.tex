...
\noindent
The scheme at the base of the \WANT\ method was originally described in 
Ref.~\cite{calz+04prb}:\\ A. Calzolari, N. Marzari, I. Souza, and M. Buongiorno Nardelli,
{\em Phys. Rev. B} {\bf 69}, 035108 (2004).
\\

\noindent
The extension to PAW and ultrasoft pseudopotentials can be found in Ref.~\cite{ferr+07jpcm}:\\
A. Ferretti, A. Calzolari, B. Bonferroni, and R. Di Felice, {\em J. Phys.: Condens. Matter} 
{\bf 19}, 036215 (2007).
\\
...
matrices $U_{mn}^{({\bf k})}$ that transform the Bloch eigenstates
