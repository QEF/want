...
# 92 "iotk_attr.spp"
    REAL (kind=iotk_REAL1), intent(out) :: out(n)
    REAL (kind=iotk_REAL1), intent(in)  :: in(n)
# 95 "iotk_attr.spp"
    out = in
...
subroutine iotk_write_REAL1(val,string,ierr)
  ...
  implicit none
  REAL(kind=iotk_REAL1), intent(in) :: val(:)
...
subroutine iotk_read_REAL1(val,string,index,ierr)
  ...
  use iotk_misc_interf
  implicit none
  REAL(kind=iotk_REAL1), intent(inout) :: val(:)
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL1_0(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
...
subroutine iotk_scan_attr_REAL1_0(attr,name,val,dummy,found,default,eos,ierr)
  ...
  character(*),             intent(in)  :: name
#ifdef __IOTK_WORKAROUND6
  REAL(kind=iotk_REAL1)                        :: val 
#else
  REAL(kind=iotk_REAL1), intent(out)           :: val 
#endif
  type(iotk_dummytype), optional :: dummy
  logical,        optional, intent(out) :: found
  REAL(kind=iotk_REAL1), optional, intent(in)  :: default 
...
# 351 "iotk_attr.spp"
  integer :: index
  REAL(kind=iotk_REAL1), allocatable :: tmpval (:)
# 354 "iotk_attr.spp"
  ierrl = 0
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL1_1(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL1_2(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL1_3(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL1_4(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL1_5(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL1_6(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL1_7(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
subroutine iotk_private_pack_REAL2(out,in,n,l)
    ...
    integer,                                    intent(in)  :: n,l
# 92 "iotk_attr.spp"
    REAL (kind=iotk_REAL2), intent(out) :: out(n)
    REAL (kind=iotk_REAL2), intent(in)  :: in(n)
# 95 "iotk_attr.spp"
    out = in
...
subroutine iotk_write_REAL2(val,string,ierr)
  ...
  use iotk_misc_interf
  implicit none
  REAL(kind=iotk_REAL2), intent(in) :: val(:)
#ifdef __IOTK_WORKAROUND6
  character(len=*)              :: string
#else
  character(len=*), intent(out) :: string
...
subroutine iotk_read_REAL2(val,string,index,ierr)
  ...
  use iotk_misc_interf
  implicit none
  REAL(kind=iotk_REAL2), intent(inout) :: val(:)
  character(len=*), intent(in) :: string
  integer, intent(inout) :: index
  integer, intent(out) :: ierr
# 175 "iotk_attr.spp"
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL2_0(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
subroutine iotk_scan_attr_REAL2_0(attr,name,val,dummy,found,default,eos,ierr)
  ...
  character(*),             intent(in)  :: name
#ifdef __IOTK_WORKAROUND6
  REAL(kind=iotk_REAL2)                        :: val 
#else
  REAL(kind=iotk_REAL2), intent(out)           :: val 
#endif
  type(iotk_dummytype), optional :: dummy
  logical,        optional, intent(out) :: found
  REAL(kind=iotk_REAL2), optional, intent(in)  :: default 
  logical,        optional, intent(in)  :: eos
  integer,        optional, intent(out) :: ierr
  integer :: ierrl
  integer :: attlen,pos,equal,namlen
...
# 351 "iotk_attr.spp"
  integer :: index
  REAL(kind=iotk_REAL2), allocatable :: tmpval (:)
# 354 "iotk_attr.spp"
  ierrl = 0
  attlen=iotk_strlen(attr)
  namlen=iotk_strlen_trim(name)
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL2_1(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL2_2(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL2_3(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL2_4(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL2_5(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL2_6(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL2_7(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
subroutine iotk_private_pack_REAL3(out,in,n,l)
    ...
    integer,                                    intent(in)  :: n,l
# 92 "iotk_attr.spp"
    REAL (kind=iotk_REAL3), intent(out) :: out(n)
    REAL (kind=iotk_REAL3), intent(in)  :: in(n)
# 95 "iotk_attr.spp"
    out = in
...
subroutine iotk_write_REAL3(val,string,ierr)
  ...
  use iotk_misc_interf
  implicit none
  REAL(kind=iotk_REAL3), intent(in) :: val(:)
#ifdef __IOTK_WORKAROUND6
  character(len=*)              :: string
#else
  character(len=*), intent(out) :: string
...
subroutine iotk_read_REAL3(val,string,index,ierr)
  ...
  use iotk_misc_interf
  implicit none
  REAL(kind=iotk_REAL3), intent(inout) :: val(:)
  character(len=*), intent(in) :: string
  integer, intent(inout) :: index
  integer, intent(out) :: ierr
# 175 "iotk_attr.spp"
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL3_0(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
subroutine iotk_scan_attr_REAL3_0(attr,name,val,dummy,found,default,eos,ierr)
  ...
  character(*),             intent(in)  :: name
#ifdef __IOTK_WORKAROUND6
  REAL(kind=iotk_REAL3)                        :: val 
#else
  REAL(kind=iotk_REAL3), intent(out)           :: val 
#endif
  type(iotk_dummytype), optional :: dummy
  logical,        optional, intent(out) :: found
  REAL(kind=iotk_REAL3), optional, intent(in)  :: default 
  logical,        optional, intent(in)  :: eos
  integer,        optional, intent(out) :: ierr
  integer :: ierrl
  integer :: attlen,pos,equal,namlen
...
# 351 "iotk_attr.spp"
  integer :: index
  REAL(kind=iotk_REAL3), allocatable :: tmpval (:)
# 354 "iotk_attr.spp"
  ierrl = 0
  attlen=iotk_strlen(attr)
  namlen=iotk_strlen_trim(name)
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL3_1(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL3_2(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL3_3(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL3_4(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL3_5(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL3_6(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL3_7(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL4_0(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL4_1(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL4_2(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL4_3(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL4_4(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL4_5(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL4_6(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
...
# 236 "iotk_attr.spp"
subroutine iotk_write_attr_REAL4_7(attr,name,val,dummy,first,newline,ierr)
  use iotk_base
  use iotk_error_interf
  use iotk_attr_interf
  use iotk_str_interf
