...
int __FC_FUNC_ (create_plan_1d, CREATE_PLAN_1D)(fftw_plan *p, int *n, int *idir)
{
...
int __FC_FUNC_ (destroy_plan_1d, DESTROY_PLAN_1D)(fftw_plan *p)
{
...
int __FC_FUNC_ (create_plan_2d, CREATE_PLAN_2D)
...
int __FC_FUNC_ (destroy_plan_2d, DESTROY_PLAN_2D)(fftwnd_plan *p)
{
...
int __FC_FUNC_ (create_plan_3d, CREATE_PLAN_3D)
...
int __FC_FUNC_ (destroy_plan_3d, DESTROY_PLAN_3D)(fftwnd_plan *p)
...
int __FC_FUNC_ (fft_x_stick, FFT_X_STICK)
...
int __FC_FUNC_ (fft_y_stick, FFT_Y_STICK)
...
int __FC_FUNC_ (fft_z_stick, FFT_Z_STICK)
...
int __FC_FUNC_ ( fftw_inplace_drv_1d, FFTW_INPLACE_DRV_1D ) 
...
int __FC_FUNC_ ( fftw_inplace_drv_2d, FFTW_INPLACE_DRV_2D ) 
...
int __FC_FUNC_ ( fftw_inplace_drv_3d, FFTW_INPLACE_DRV_3D ) 
   ( fftwnd_plan *p, int *nfft, FFTW_COMPLEX *a, int *inca, int *idist)
{
   fftwnd( *p, (*nfft), a, (*inca), (*idist), 0, 0, 0 );
   return 0;
