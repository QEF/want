...
subroutine readpp
  ...
  USE pseudo_types_module,     ONLY : pseudo_upf, nullify_pseudo_upf, deallocate_pseudo_upf
  USE read_uspp_module,        ONLY : readvan, readrrkj
  USE upf_to_internal,         ONLY : set_pseudo_upf
  USE atom_module,             ONLY : msh, rgrid
  USE uspp_param,              ONLY : newpseudo
  USE ions_module,             ONLY : nsp, psfile, zv
  USE funct_module,            ONLY : get_iexch, get_icorr, get_igcx, get_igcc
  USE io_module,               ONLY : pseudo_dir
  USE io_global_module,        ONLY : stdout
  USE uspp_param,              ONLY : upf
  use upf_module,              ONLY : read_upf
  use radial_grids_module,     ONLY : deallocate_radial_grid, nullify_radial_grid
